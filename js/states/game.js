SpaceShooter.States.Game=function(game){}

SpaceShooter.States.Game.prototype={
	...
	create: function() {
		...
		this.background2=game.add.tileSprite(0,0,480,800,'background_layer_2');
		this.background2.autoScroll(10,100);
		//create player ship
		this.player.create();
		...
		this.music = game.add.audio('game_music_1',1 ,true);
		this.music.play();
	...
	afterBattleMenu: function(){
		...
		if(newRecord){
			game.add.tween(this.newHighScore).to( { alpha: 0}, 1000, Phaser.Easing.Linear.None, true)
		};
